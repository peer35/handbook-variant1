...
- **`tools/`** - Manuals to help researchers use specific tools 
...
├── index.qmd - Homepage `/`
├── tools/ - Folder containing all manuals and subpages
├── tools.qmd - Manual overview page
├── tools/<tool>/ - <tool> manuals
├── tools/<tool>/index.qmd - Manual start page
├── tools/<tool>/_sidebar.yml - Manual sidebar definition
