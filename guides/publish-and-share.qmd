...
According to the [VU Research Data and Software Management Policy](../topics/research-data-and-software-management-policy.qmd), all publication-related data should be archived for at least **ten years** for verification and replication of research. For this purpose, VU Amsterdam offers researchers two options to archive their data in one of the organisational repositories (DataverseNL and Yoda). Other archival options may be used depending on the discipline as described in faculty data management policy documents.  
...
1. [DataverseNL](../topics/dataversenl.qmd) - an online platform for the publication of citable research data in a semi-open environment. DataverseNL allows users to link publications to datasets directly, and to share the data through online archives such as DANS.
...
2. [Yoda](../topics/yoda.qmd) - besides [active storage](../topics/data-storage.qmd), Yoda also has an archive function: the vault. You can use the vault in two ways:
...
* [Scientific Data - Nature](https://www.nature.com/sdata/aims-and-scope)
...
```{.include shift-heading-level-by=2}
../tools/pure/registration/data-registration.qmd
```
