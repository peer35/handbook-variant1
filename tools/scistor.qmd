...
Although SciStor is most useful on campus you can also [access your shares off-campus](/tools/scistor/scistor-connection.qmd#off-campus-access).
...
Snapshots act like “photo moments” of your data, enabling you to restore previous versions. Users can recover their own data by following this [instructions.](/tools/scistor/snapshots-data-recovery.qmd#overview)

## Getting started

The RDM Handbook has practical [manuals](/tools/scistor/index.qmd) for users starting with SciStor.
