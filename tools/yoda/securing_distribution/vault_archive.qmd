...
After archiving your data, you can optionally [publish it](/tools/yoda/securing_distribution/vault_publish.qmd), making your dataset findable on the internet. If you classify your data as **open - freely retrievable**, then the data itself can be downloaded anonymously by any third party.
...
![Actions menu](/public/tools/yoda/arch-compliance.png)

Choose a preferred fomat and the system will show you a list of filetypes in your data folder which are not compliant.

![Check for DANS compliance](/public/tools/yoda/arch-compliance-dans.png)
...
[the metadata form of the folder](/tools/yoda/using_yoda/workflow_metadata.qmd).

2. Now press the &ldquo;Actions (Submit)&rdquo; button. 

![Submit](/public/tools/yoda/arch-submit.png)
...
If the status of your data package changes you will receive a notification in the portal. You can also choose to get [notifications via email](/tools/yoda/yoda_portal/notifications.qmd).
...
![Go to Vault button](/public/tools/yoda/arch-gotovault.png)
