...
![](/public/tools/yoda/cbd-preferences.png)
...
![](/public/tools/yoda/cbd-preferences-set.png)
...
1. First create a new bookmark by pressing the + button on the lower left side of the screen.

![](/public/tools/yoda/cbd-add-bookmark.png)

2. You will now see a new connection page:

![](/public/tools/yoda/cbd-new-connection.png)

3. Click on the "FTP (File Transfer Protocol)" dropdown list and select a **WebDAV (HTTPS)** connection and you will see the WebDAV (HTTPS) connection page.

![](/public/tools/yoda/cbd-new-connection-webdav.png)

![](/public/tools/yoda/cbd-new-webdav.png)

4. Fill in the following information in the appropriate blocks

First generate a [Data Access Password](/tools/yoda/data_access/yoda_dap.qmd). 

- Server: **data.yoda.vu.nl**
- Username: your email address
- Password: paste (CTRL-v) the data access password you created in the portal. 

5. Cyberduck uses your home folder as a default directory to download files. This can be changed by clicking on "More Options" and choosing a new folder

![](/public/tools/yoda/cbd-new-webdav-options.png)

6. You have successfully created a bookmark, close the editing window by clicking on the R X button on the top right of the edit window to return to the main Cyberduck screen.

### How To: Connecting to Yoda

The main screen shows all the connections (bookmarks) you have defined. 

1. To connect, double click on the bookmark (in this case "data.yoda.vu.nl - WebDAV (HTTPS)") and you will be connected.

![](/public/tools/yoda/cbd-main-bookmark.png)

2. If you did not fill in your password in the bookmark you will be asked to do so now. Please note, "Save password" is automatically selected by Cyberduck, you may decide to (un)check this option. Fill in your vunet-id password and click " **Login**" to connect.

![](/public/tools/yoda/cbd-login-screen.png)

- If your login unexpectedly fails, please check if your [data access password](/tools/yoda/data_access/yoda_dap.qmd) is still valid.

You should now see your project directory in an explorer like window:

![](/public/tools/yoda/cbd-project-folders.png)

## How To: Working with Yoda folders and uploading/downloading files

1. Click on a \> to open a folder,

![](/public/tools/yoda/cbd-folder-navigate-1.png)

- or double click to open in the main window.

![](/public/tools/yoda/cbd-folder-navigate-2.png)

2. Use the left, right and up arrows to navigate the directory tree and right click on the main window to create a new folder:

![](/public/tools/yoda/cbd-folder-create.png)

- Alternatively, drag-and-drop folders and files from Windows Explorer to your Yoda project folders:

![](/public/tools/yoda/cbd-folder-drag-and-drop.png)

3. In either case, once copying has started you should see the transfer window. Keep this open until the transfer is complete. 

![](/public/tools/yoda/cbd-file-file-transfer.png)
...
![](/public/tools/yoda/cbd-file-right-click.png)
...
![](/public/tools/yoda/cbd-error-cannot-delete.png)
...
![](/public/tools/yoda/cbd-preferences-set-checksum.png)
