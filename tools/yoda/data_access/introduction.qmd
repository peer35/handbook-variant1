...
There are several methods to access Yoda data via WebDAV, they depend on the Operating System you are using:
  ...
  * [Accessing Yoda data on Windows](/tools/yoda/data_access/data_access_windows.qmd)
  * [Accessing Yoda data on MacOS](/tools/yoda/data_access/data_access_macos.qmd)
  * [Accessing Yoda data on Linux](/tools/yoda/data_access/data_access_linux.qmd)
...
Power users who are comfortable with command line tools can use the [iRODS icommands](/tools/yoda/data_access/yoda_using_icommands.qmd) to
