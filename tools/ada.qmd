...
You can find information on how to use ADA on the [ADA MANUAL page](https://rdm.vu.nl/tools/ada/index.html). Also take a look at the [SURF wiki Snellius pages](https://servicedesk.surf.nl/wiki/display/WIKI/Snellius), which contains a lot of information that applies to ADA as well.
