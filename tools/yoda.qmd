...
From the Yoda Vault you can submit the dataset for **publication**. A [DOI](https://www.doi.org/the-identifier/what-is-a-doi/) will be generated and registered with [DataCite](https://commons.datacite.org/doi.org?query=client.uid:delft.vudata) together with the metadata. DataCite ensures your dataset becomes findable on the internet and citable.
...
## Getting Started
The RDM Handbook has practical [manuals](/tools/yoda/index.qmd) for users starting with Yoda.
